...
PRODUCT_COPY_FILES += \
    vendor/maxi/config/permissions/backup.xml:system/etc/sysconfig/backup.xml
...
# CMSDK
include vendor/maxi/config/cmsdk_common.mk
...
DEVICE_PACKAGE_OVERLAYS += vendor/maxi/overlay/common
...
ifneq ($(PRODUCT_DEFAULT_DEV_CERTIFICATE),build/target/product/security/testkey)
  ifneq ($(MAXI_BUILDTYPE), UNOFFICIAL)
    ...
    MAXI_DISPLAY_VERSION=$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(TARGET_VENDOR_RELEASE_BUILD_ID)
  endif
endif
endif
