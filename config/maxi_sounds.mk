...
ALARM_PATH := vendor/maxi/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/maxi/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/maxi/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/maxi/prebuilt/common/media/audio/ui
